...
!(function (a, b) {
                    ...
                    this.fullscreen = a =
                        {
                            support: {
                                ...
                                webkitVideo:
                                    "function" == typeof e[f.webkitVideo[2]],
    ...
    var g = function (b) {
        ...
        d &&
            (a.each(
                a.jPlayer.keyIgnoreElementNames.split(/\s+/g),
                function (a, d) {
    ...
    (a.jPlayer.keys = function (b) {
        ...
        (a.jPlayer.prototype = {
                ...
                repeat: function (b) {
                    b.jPlayer.options.loop
                        ? a(this)
                              ...
                              .bind(
                                  a.jPlayer.event.ended +
                                      ".jPlayer.jPlayerRepeat",
                                  function () {
                                      a(this).jPlayer("play");
                                  }
                              )
                ...
                if (
                    ...
                    a.each(this.formats, function (b, d) {
                        (c.html.canPlay[d] =
                            ...
                            (c.aurora.canPlay[d] =
                                a.inArray(d, c.aurora.formats) > -1),
                            (c.flash.canPlay[d] =
                    ...
                    a.each(this.formats, function (a, b) {
                        (c.html.support[b] =
                            c.html.canPlay[b] && c.html.desired),
                            (c.aurora.support[b] =
                                c.aurora.canPlay[b] && c.aurora.desired),
                            (c.flash.support[b] =
                                c.flash.canPlay[b] && c.flash.desired);
                    }),
                    (this.html.used = !1),
                    (this.aurora.used = !1),
                    (this.flash.used = !1),
            ...
            _getAuroraStatus: function (a, b) {
                ...
                (this.status.duration = a.duration / 1e3),
                    ...
                    a.buffered > 0
                        ? ((e =
                              this.status.duration > 0
                                  ? (a.buffered * this.status.duration) /
                                    this.status.duration
                                  : 100),
                          (f =
                              this.status.duration > 0
                        ...
                        ? ((this.status.nativeVideoControls &&
                          ...
                          "string" == typeof b.title &&
                              (this.css.jq.title.length &&
                                  this.css.jq.title.html(b.title),
                              this.htmlElement.audio &&
            ...
            repeat: function (a) {
                var b = "object" == typeof a;
                this._loop(
                    b && this.options.useStateClassSkin && this.options.loop
                        ? !1
                        : !0
                );
            },
                            ...
                            if (g[f[h]] === b)
                                return (
                                    this._warning({
                                        ...
                                        context: c,
                                        message:
                                            a.jPlayer.warningMsg.OPTION_KEY,
                ...
                switch (b) {
                    ...
                    case "playbackRate":
                        (this.options[b] = c =
                            ...
                            this.html.used &&
                                this._html_setProperty("playbackRate", c),
                            this._updatePlaybackRate();
                        break;
                    ...
                    case "fullScreen":
                        if (this.options[b] !== c) {
                            var e =
                                a.jPlayer.nativeFeatures.fullscreen.used
                                    .webkitVideo;
                ...
                var a = this,
                    ...
                    e = function (b) {
                        ...
                        "undefined" != typeof a.internal.mouse
                            ...
                            e &&
                                a.css.jq.gui.fadeIn(
                                    a.options.autohide.fadeIn,
                                    function () {
                                        clearTimeout(a.internal.autohideId),
                                            (a.internal.autohideId = setTimeout(
                                                function () {
                                                    a.css.jq.gui.fadeOut(
                                                        a.options.autohide
                                                            .fadeOut
                                                    );
                                                },
            ...
            _html_playHead: function (a) {
                ...
                try {
                    if ("object" == typeof c.seekable && c.seekable.length > 0)
                        c.currentTime =
                            (a * c.seekable.end(c.seekable.length - 1)) / 100;
                    else {
            ...
            _aurora_playHead: function (a) {
                this.aurora.player.duration > 0 &&
                    this.aurora.player.seek(
                        (a * this.aurora.player.duration) / 100
                    ),
            ...
            _emulateHtmlBridge: function () {
                ...
                a.each(a.jPlayer.emulateMethods.split(/\s+/g), function (a, c) {
                    ...
                    a.each(a.jPlayer.event, function (c, d) {
                        var e = !0;
                        a.each(
                            a.jPlayer.reservedEvent.split(/\s+/g),
                            function (a, b) {
            ...
            _emulateHtmlUpdate: function () {
                ...
                a.each(a.jPlayer.emulateStatus.split(/\s+/g), function (a, c) {
                    ...
                    a.each(
                        a.jPlayer.emulateOptions.split(/\s+/g),
                        function (a, c) {

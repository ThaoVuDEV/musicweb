                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li class="has-dropdown">
                                                            ...
                                                            <ul class="submenu">
                                                                ...
                                                                <li><a href="index-2-rtl.html">Home Style 02
                                                                        RTL</a>
                                                                </li>
                                                                <li><a href="index-3-rtl.html">Home Style 03
                                                                        RTL</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    <ul class="mega-menu">
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="genres-details.html">genres
                                                                        details</a>
                                                                </li>
                                                                ...
                                                                <li><a href="work-system.html">how it works</a>
                                                                </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="ideas-advice-details.html">ideas
                                                                        advice
                                                                        details</a></li>
                                ...
                                <div class="header__action-inner d-flex align-items-center">
                                    <div class="enquiry__list ml-10 mr-10 ms-browse-act-wrap p-relative">
                                        <div class="ms-enquiry-box p-relative d-none d-xl-inline-flex">
                                            <a href="#"><i class="flaticon-star icon"></i> <span
                                                    class="text">My

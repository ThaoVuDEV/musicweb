            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img id="header-lang-img" src="admin/images/flags/us.svg" alt="Header Language"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                            ...
                            <img src="admin/images/flags/us.svg" alt="user-image" class="me-2 rounded"
                                height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language"
                            ...
                            <img src="admin/images/flags/ae.svg" alt="user-image" class="me-2 rounded"
                                height="18">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="admin/images/users/avatar-1.jpg" alt="Header Avatar">
